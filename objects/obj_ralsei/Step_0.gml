...
sprite_index = spr_RWD 
} else if inparty = true{
	
	sprite_index = spr_RWL

}
 if inparty = true{
	
	sprite_index = spr_RWR

}
 if inparty = true{
	
	sprite_index = spr_RWU
...
if inparty = true and obj_player.follow_points > 0{
 ...
 if global.party_member_1 = self{
	 ...
	 case spr_KWD: sprite_index = spr_RWD; break
	  case spr_KWL: sprite_index = spr_RWL; break
	   case spr_KWR: sprite_index = spr_RWR; break
	    case spr_KWU: sprite_index = spr_RWU; break
	 }
