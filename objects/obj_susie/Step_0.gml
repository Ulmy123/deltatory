...
sprite_index = spr_SWD 
} else if inparty = true{
	
	sprite_index = spr_SWL

}
 if inparty = true{
	
	sprite_index = spr_SWR

}
 if inparty = true{
	
	sprite_index = spr_SWU
...
if inparty = true and obj_player.follow_points > 0{
 ...
 if global.party_member_1 = self{
	 ...
	 case spr_KWD: sprite_index = spr_SWD; break
	  case spr_KWL: sprite_index = spr_SWL; break
	   case spr_KWR: sprite_index = spr_SWR; break
	    case spr_KWU: sprite_index = spr_SWU; break
	 }
